/* Ejercicio 18.8  (estadistica.c)
      Programa que lee una frase y a continuación muestra las siguientes estadísticas:
        Veces que se han introducido los caracteres: '.', espacio, ',', ';', ':'
