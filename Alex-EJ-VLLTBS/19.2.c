/* EJERCICIO 19.2  (buscaNumero.c)
      Escribir un programa que rellene un array de 10 números enteros (los
      valores se pedirán al usuario). A continuación el programa pedirá un
      número al usuario y buscará dicho valor en el array. Si lo encuentra,
      nos dirá la posición en la que está; si no, nos dirá que el número no
      está almacenado en el array. El programa pedirá números al usuario para
      buscarlos hasta que éste introduzca el cero.
      (Una vez que se encuentre el número, no es necesario continuar).
*/
