/* EJERCICIO 25.3  (ordenarDecreciente.c)
     Realiza una función que ordene los números de un vector de enteros que
     reciba como parámetro. Los elementos se ordenarán de mayor a menor.
     Diseña el prototipo de la función y haz un programa que la pruebe.
*/
