/* EJERCICIO 26.5  (potenciaImproved.c)
   Mejora la función anterior para que se puedan manejar exponentes negativos.
   Cambia el prototipo de la función si fuese necesario. Recuerda que, por 
   ejemplo, 10 elevado a -1 es igual a 1/10. 
   La función: int abs(num); devuelve el valor absoluto de un número.
*/
