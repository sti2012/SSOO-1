/* EJERCICIO 24.5.  añadeNcaracteres.c
      Escribir un programa que lea dos cadenas de texto por teclado y 
      añada los 5 primeros caracteres de la segunda cadena en la primera. 
*/
