/* EJERCICIO 19.3  (buscarNumeroEstat.c)
      ...
      terminar, la siguiente estadística:
      - número medio de elementos que se recorrieron en el array en las
        búsquedas en las que el número estaba en el array.
      Ejecutar un número alto de búsquedas y anotar el valor medio calculado.
*/
