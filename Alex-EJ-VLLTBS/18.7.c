/* Ejercicio 18.7  (frase2mayusculas.c)
      Programa que lee una frase y la escribe con todas las letras en mayúsculas.
      Nota: la función:  int toupper(int); cuyo prototipo está en ctype.h
      convierte el código ascii pasado, si es una minúscula, a mayúsculas.
      Aunque esta función maneja enteros, puede trabajar también con el tipo char.
*/
