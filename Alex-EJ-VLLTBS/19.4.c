/* EJERCICIO 19.4  (numerosOrdenados.c)
       ...
       números que se almacenarán en el array, el programa obligue al usuario
       a introducir números mayores o iguales al anterior introducido.
       Modificar la condición de búsqueda, teniendo en cuenta que ahora los
       números en el array estarán ordenados de menor a mayor.
*/
