/* EJERCICIO 24.4.  añadeCadenas.c
      Hacer un programa que lea cadenas de caracteres hasta que el 
      usuario introduzca una cadena vacía y las vaya concatenando en 
      una cadena. Elegir un tamaño para la cadena destino (donde se
      van añadiendo) de 200 elementos y comprobar que no se supera este
      límite, es decir, que si el añadir una nueva cadena supone superar
      el tamaño de la cadena, se dará un mensaje de error y se terminará.
      Mostrar la cadena resultante antes de finalizar el programa.     
*/
