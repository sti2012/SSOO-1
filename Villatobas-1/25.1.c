/* EJERCICIO 25.1  (horasMinSec.c)
     Diseña una función que reciba como parámetro un número de segundos y
     calcule las horas, minutos y segundos correspondientes a tales segundos.
     La función tendrá como prototipo: 
                void hms(int segTotales, ? horas, ? minutos, ? segundos);
     Completa el prototipo. Los últimos tres parámetros contendrán los valores
     calculados por la función. Escribe un programa que pruebe dicha función.
*/
