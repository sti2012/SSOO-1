/* Ejercicio 18.1 
        Copia y compila el programa 18. Anota cuántos bytes ocupa el programa
        ejecutable generado, indicando el sistema operativo utilizado.
        ¿Qué ocurre si en el mensaje introducimos palabras separadas por
        espacios?
*/
