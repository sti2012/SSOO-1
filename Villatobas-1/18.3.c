/* Ejercicio  18.2  (longitudCadena.c)
       La longitud de una cadena de caracteres es el número de caracteres que
       tiene dicha cadena, sin contar el terminador. Modifica el programa 18
       para que calcule e imprima por pantalla cuál es la longitud de las tres
