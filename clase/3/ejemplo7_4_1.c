...
int numeroRegistros = 0;//numero de registros introducidos
...
/*Imprime el menu y devuelve la opcion del usuario*/
int imprimeMenu(){
    int c=0;
    char retorno;
    printf("---------------- Listin telefonico: -------------\n\n");
    printf("\t\t1.Introducir usuario   \n");
    printf("\t\t2.Buscar usuario       \n");
    printf("\t\t3.Imprimir listin      \n");
    printf("\t\t4.Salir                \n\n");
...
void introducirUsuario(){
    ...
    if (numeroRegistros==MAX){
        ...
        numeroRegistros++;
        printf ("El usuario ha sido introducido con exito\n");
    }
}
