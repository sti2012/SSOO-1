...
MatrizDispersa appendElemento(const MatrizDispersa matriz,
    ...
    nuevoElemento=(struct ElementoLista*) malloc(sizeof(struct ElementoLista));
...
MatrizDispersa deleteElemento(const MatrizDispersa matriz,int fila,int columna){
    struct ElementoLista* elementoParaBorrar=findElemento(matriz,fila,columna);
