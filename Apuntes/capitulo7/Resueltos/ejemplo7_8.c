...
struct ArticuloLista* findArticulo(const Almacen almacen, const char *nombre){
...
Almacen appendArticulo(const Almacen almacen, const char *nombre){
    ...
    if (nuevoArticulo==NULL || almacen==NULL){
        nuevoArticulo=(struct ArticuloLista*) malloc(sizeof(struct ArticuloLista));
...
Almacen deleteArticulo(const Almacen almacen, const char *nombre){
    struct ArticuloLista* articuloParaBorrar = findArticulo(almacen,nombre);
