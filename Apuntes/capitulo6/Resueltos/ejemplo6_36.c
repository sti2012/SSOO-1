...
long int convertirHoraComienzo(char diaComienzo, int horaComienzo,
    ...
    case 'L':
        break;
    case 'M':
        minutoAbsoluto+=  24*60;
        break;
    case 'X':
        minutoAbsoluto+=2*24*60;
        break;
    case 'J':
        minutoAbsoluto+=3*24*60;
        break;
    case 'V':
        minutoAbsoluto+=4*24*60;
        break;
    case 'S':
        minutoAbsoluto+=5*24*60;
        break;
    case 'D':
        minutoAbsoluto+=6*24*60;
        break;
    }
...
float calcularCoste(long int comienzoAbsoluto, int duracionMinutos){
    long int limiteFranja[12]={   0, /* Lunes   0'00 */
                                  8*60, /* Lunes,  8'00 */
                                  16*60, /* Lunes, 16'00 */
    ...
    float costeFranja[11]={   0.03, /* Lunes   0'00 */
                              0.12, /* Lunes,  8'00 */
                              0.03, /* Lunes, 16'00 */
                              0.12, /* Martes,  8'00 */
                              0.03, /* Martes, 16'00 */
